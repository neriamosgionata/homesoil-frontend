...
<div class="flex flex-col p-3 bg-white border border-gray-300 rounded">
    ...
    <div aria-roledescription="button" role="button" tabindex={index}>
        ...
        <div class="flex flex-col justify-center py-2">
            ...
            {:else}
                <input type="text" class="w-10/12 p-2 text-sm text-gray-700 border border-gray-300 rounded mx-auto"
                       bind:value={newName}
