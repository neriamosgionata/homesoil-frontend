...
import type { Clicks, CustomSelectProps } from "../types";
...
export default function CustomSelect(props: CustomSelectProps) {
	...
	const onOptionClick: any = useCallback(
		...
		() =>
			classNames({
				...
				[`react-js-cron-custom-select-dropdown-minutes-large`]:
					(unit.type === "minutes" || unit.type === "minutes-steps") && period !== "hour" && period !== "day",
				[`react-js-cron-custom-select-dropdown-minutes-medium`]:
					(unit.type === "minutes" || unit.type === "minutes-steps") &&
