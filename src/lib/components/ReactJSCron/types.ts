...
export type PeriodType = "year" | "month" | "week" | "day" | "hour" | "minute" | "minutes-steps" | "reboot";
export type AllowEmpty = "always" | "never" | "for-default-value";
export type CronType = "period" | "months" | "month-days" | "week-days" | "hours" | "minutes" | "minutes-steps";
export type LeadingZeroType = "month-days" | "hours" | "minutes" | "minutes-steps";
...
export type DropdownsConfig = {
	...
	"minutes-steps"?: Omit<DropdownConfig, "humanizeLabels" | "humanizeValue">;
...
export interface PeriodProps
	extends Omit<FieldProps, "value" | "setValue" | "period" | "periodicityOnDoubleClick" | "mode" | "filterOption"> {
	value: PeriodType;
...
export interface MinutesStepsProps extends FieldProps {
	leadingZero: LeadingZero;
	clockFormat?: ClockFormat;
}
...
export type FilterOption = ({ value, label }: { value: string; label: string }) => boolean;
