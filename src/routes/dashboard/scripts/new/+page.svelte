...
<div class="container">
    <div class="bg-gray-100 rounded-lg shadow-xl py-2 text-black">
        ...
        <div class="py-2">
            <div class="p-4">
                <p>
                    <a href="/dashboard/scripts" class="font-bold text-xl text-blue-400 hover:underline">Back to Scripts</a>
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1">
            <div class="p-4">
                <label
                        for="title"
                        class="font-bold my-2 p-1 block"
                >
            ...
            <div class="p-4">
                ...
                <ScriptEditor
                        code=""
                        on:save={(e) => {new_script.code = e.detail.code}}
                        on:editing={(e) => {disabled = disabled || e.detail.isEditing}}
                />
            </div>
            <div class="p-4">
                <label
                ...
                <CronInput
                        cron={null}
                        on:change={(e) => {new_script.schedule = e.detail.value || null}}
                />
            </div>
            <div class="p-4">
                <button
